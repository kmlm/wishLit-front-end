...
var config = {
  apiOrigins: {
    production: 'https://kevin-full-stack-project.herokuapp.com/',
...
var resetModals = function resetModals(event) {
...
var onAddToList = function onAddToList(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.addToList(data).then(ui.addToListSuccess).catch(ui.addToListFailure);
};

var returnMyLit = function returnMyLit(event) {
  event.preventDefault();
  api.returnLit().then(ui.returnLitSuccess).then(removeModal).then(removeBook).then(openEditModal).then(editBook).catch(ui.returnLitFailure);
};
...
var removeBook = function removeBook(data) {
  $('#destroy-modal-yes-button').on('click', function () {
    api.destroyBook(data).then(ui.destroyBookSuccess).catch(ui.destroyFailure);
  });
};
...
var openEditModal = function openEditModal() {
  $('.edit-lit-button').on('click', function () {
    ...
    var id = $(this).parent().attr('data-id');
    api.fillForm(id).then(ui.openEditModalSuccess).then(editBook).catch(ui.openEditModalFailure);
  });
};
...
var editBook = function editBook(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.updateBook(data).then(ui.updateBookSuccess).catch(ui.updateBookFailure);
};
...
var returnLit = function returnLit() {
  return $.ajax({
    url: config.apiOrigin + 'books/',
    method: 'GET',
    headers: {
...
var destroyBook = function destroyBook(data) {
  return $.ajax({
...
var store = __webpack_require__(3);
var showBooksTemplate = __webpack_require__(18);

var fillFormTemplate = __webpack_require__(35);
...
var addToListSuccess = function addToListSuccess(data) {
...
var addToListFailure = function addToListFailure() {
  $('#addLitMessage').text('Make sure you have provided a title!');
  document.getElementById('lit-input-form').reset();
  // document.getElementById('lit-input-form').reset()
};

var returnLitSuccess = function returnLitSuccess(data) {
  $('#my-lit-button').hide();
  $('#my-list-title').text('');
  $('.content').show();
  var renderBooks = showBooksTemplate({ books: data.books });
  $('.content').html(renderBooks);
  $('.cards').css('height', '50px');
};

var destroyBookSuccess = function destroyBookSuccess(data) {
  document.getElementById('my-lit-button').click();
  $('#add-message').text('Successfully Deleted!');
};

var destroyBookFailure = function destroyBookFailure() {};

var updateBookSuccess = function updateBookSuccess(data) {
...
var openEditModalSuccess = function openEditModalSuccess(data) {
  var fillForm = fillFormTemplate({ books: data });
  $('.modalForm').html(fillForm);
};

var openEditModalFailure = function openEditModalFailure() {};
...
module.exports = {
  ...
  addToListFailure: addToListFailure,
  returnLitSuccess: returnLitSuccess,
  ...
  openEditModalSuccess: openEditModalSuccess,
  openEditModalFailure: openEditModalFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!--\nbooks was defined as key in function as parameter in showBooksTemplate\nhandlebars only takes one parameter -->\n\n  <div\n  data-id=\""
    ...
    + " </p>\n  <button class='remove' type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#destroyModal\"\n  > REMOVE </button>\n  <button class='edit-lit-button' type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#editLitModal\">\nEDIT\n</button>\n   <hr>\n\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<!--\nbooks was defined as key in function as parameter in showBooksTemplate\nhandlebars only takes one parameter -->\n\n  <!-- <div\n  data-id=\""
    ...
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author : stack1), depth0))
    + " </p>\n      <p> ISBN: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.isbn : stack1), depth0))
    + " </p>\n      <p> Price: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + " </p>\n  <button class='remove'> REMOVE </button>\n  <button class='edit-lit-button' type=\"button\" class=\"btn btn-primary\" data-toggle=\"modal\" data-target=\"#editLitModal\">\nEDIT\n</button>\n   <hr> -->\n\n   <form id='lit-update-form'>\n     Title <input class='myListFields' type='text' name=\"book[title]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.title : stack1), depth0))
    + "\">\n     <br>\n     <br>\n     Author <input class='myListFields' type='text' name=\"book[author]\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.author : stack1), depth0))
    + "\">\n     <br>\n     <br>\n     Link <input class='myListFields' type='url' name=\"book[link]\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.link : stack1), depth0))
    + " >\n     <br>\n     <br>\n     Price <input class='myListFields' type='number' step='.01' name=\"book[price]\" value="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
    + ">\n     <br>\n     <br>\n     <input id='edit-lit-button' class='submitButton' type=\"submit\" name='submit' value='Save'>\n   </form>\n   <br>\n   <section id='editLitMessage'></section>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
